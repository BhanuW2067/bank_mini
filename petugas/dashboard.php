...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center">Selamat Datang, Petugas!</h1>
        <p class="lead text-center">Gunakan menu ini untuk mengelola data nasabah dan transaksi bank mini.</p>
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Kelola setoran, penarikan, dan transfer nasabah.</p>
                        <a href="transaksi.php" class="btn btn-success">Proses Transaksi</a>
                    </div>
                </div>
            </div>
        </div>
