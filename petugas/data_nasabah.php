...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row mb-3">
            ...
            <!-- Kolom untuk Tombol Tambah Nasabah -->
            <div class="col-md-4 text-end">
                <a href="tambah_nasabah.php" class="btn btn-primary">Tambah Nasabah</a>
            </div>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_nasabah.php?id=<?= $row['id_nasabah'] ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="hapus_nasabah.php?id=<?= $row['id_nasabah'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus nasabah ini?');">Hapus</a>
